...
export const usersReducer = (state=initialUsersState, action) => {
    switch (action.type) {
        ...
        case FETCH_USERS_SUCCESS: {
            return {...state, loading: false, error: false, data: action.payload.data, total: action.payload.total, minDate: action.payload.minDate, maxDate: action.payload.maxDate}
        }
        default: {
            return state;
        }
